...
public class MyListPerformanceTEst {
    ...
    public static void main(String[] args) {
        ...
        search(arrayList, loop, 0); // O(1)
        search(arrayList, loop, size / 2); // O(1)
        search(arrayList, loop, size - 1); // O(1)
        ...
        search(linkedList, loop, 0); // O(1)
        search(linkedList, loop, size / 2); // O(N)
        search(linkedList, loop, size - 1); // O(N)
